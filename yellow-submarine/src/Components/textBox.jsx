                ...
                <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
                    <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                        <div class="text-white sm:text-lg dark:text-white">
                            <h1 class="mb-4 text-3xl font-extrabold tracking-tight text-amber-500 dark:text-amber-500"> PHYTOPLANKTON </h1>
                            <p class="mb-8 font-light lg:text-xl">
                                One of the organisms in the Ocean that have a big impact for us are Phytoplankton
                            </p>
                            </div>
                ...
                <div class="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
                    <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
                        <div class="text-white sm:text-lg dark:text-white">
                            <h1 class="mb-4 text-3xl font-extrabold tracking-tight text-amber-500 dark:text-amber-500"> PHYTOPLANKTON </h1>
                            <p class="mb-8 font-light lg:text-xl">
                                Phytonplankton are microorganisms that are plant-like and generate resources like nutrients and oxygen
